...
const metrics = [
  { icon: Tv, value: 21000, suffix: "+", label: "Live TV Channels" },
  { icon: Film, value: 65000, suffix: "+", label: "Movies & Series VOD" },
  { icon: Activity, value: 99.9, suffix: "%", label: "Server Uptime" },
  { icon: Users, value: 12000, suffix: "+", label: "Worldwide Subscribers" },
]
